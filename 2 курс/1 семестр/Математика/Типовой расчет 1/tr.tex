...
\begin{document}
	...
	\begin{enumerate}[wide, labelwidth=!, labelindent=0pt]
		...
		\begin{center}
			\begin{tikzpicture}
				...
				xticklabels={$\pi/2$,$-\pi/4$,$0$,$\pi/4$,$\pi/2$}
					...
					\addplot[black,domain=-2:2,unbounded coords=jump,samples=101, name path=A] {pi/(2*x)};
					\node[label={0:{$y=\frac{\pi}{2x}$}}] at (axis cs:-1.68,-1.3) {};
					
					\addplot[black,domain=-1.5707963267948966:1.5707963267948966, samples=101, name path=B] {sin(deg(x))};
					\node[label={0:{$x=\arcsin y$}}] at (axis cs:0.3,0.3) {};
					
					\addplot[black, name path=D] {8*x/pi};
					\node[label={0:{$y=\frac{8x}{\pi}$}}] at (axis cs:0.08,1.3) {};
					
					\addplot[gray!30,opacity=0.6] fill between[of=B and D,soft clip={domain=-1.5707963267948966:1.5707963267948966}];
					
					\node[label={0:{$D$}}] at (axis cs:0.7,1.2) {};
					
					\addplot[black, name path=C, opacity=0] coordinates {(pi/4,2.1) (1.7,2.1) (pi/2,0.9)};
					\addplot[black, name path=E, opacity=0] coordinates {(-pi/4,-2.1) (-1.7,-2.1) (-pi/2,-0.9)};				
					\addplot[white!30,opacity=1] fill between[of=A and C,soft clip={domain=0.1:1.5707963267948966}];
					\addplot[white!30,opacity=1] fill between[of=A and E,soft clip={domain=-1.5707963267948966:-0.1}];
					
					\node[label={135:{$0$}} ] at (axis cs:0,0) {};
					...
					\node[label={80:{$(-\pi/2,-1)$}},circle,fill,inner sep=2pt] at (axis cs:-1.5707963267948966,-1) {};
					\node[label={180:{$(-\pi/4,-2)$}},circle,fill,inner sep=2pt] at (axis cs:-0.7853981633974483,-2) {};
				\end{axis}
			\end{tikzpicture}
		\end{center}
		...
		В силу нечетности кривых площадь $D$, при $x > 0$ будет равна площади $D$, при $x < 0$. Площадь $ S $ области $ D $ представим в виде удвоенной суммы площадей областей $ D_{1} $ и $ D_{2} $:
